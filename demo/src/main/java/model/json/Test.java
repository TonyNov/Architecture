...
public class Test {
    public static void main(String[] args) {
        ...
        news.setPublicationDate(LocalDate.of(2025, 8, 15));
        ...
        news.setPublicationDate(LocalDate.of(2025, 9, 22));
        ...
        news.setPublicationDate(LocalDate.of(2025, 10, 12));
        ...
        news.setPublicationDate(LocalDate.of(2025, 7, 16));
        ...
        news.setPublicationDate(LocalDate.of(2025, 11, 1));
